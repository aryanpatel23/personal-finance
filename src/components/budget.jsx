...
export default function Budgets() {
  ...
  return (
    ...
    <main className="flex-1 p-8 w-full max-w-full h-full ">
          ...
          <div className="bg-white rounded-xl shadow p-12 flex flex-col items-center">
            ...
            {(() => {
              ...
              const chartData = budgets.map((budget) => ({
                ...
                fill: budget.theme || categoryColors[budget.category] || "#ccc",
              }));
              ...
              const totalSpent = chartData.reduce((sum, b) => sum + b.spent, 0);
              return (
                <ChartContainer
                  config={chartConfig}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      <span
                        className={
                          formData.category ? "text-[#201F24]" : "text-gray-500"
                        }
                      >
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={
                            formData.theme ? "text-[#201F24]" : "text-gray-500"
                          }
                        >
